...
Целью данной работы является разработка веб-приложения для коллективного обмена учебными материалами студентов с возможностью структурирования, поиска и сохранения материалов в избранное. Для достижения поставленной цели необходимо решить следующие задачи:
#myenum[
